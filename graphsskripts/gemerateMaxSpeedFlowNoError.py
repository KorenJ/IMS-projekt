...
file1 = open("../output/flowmax1noerror.txt", 'r')
file2 = open("../output/flowmax2noerror.txt", 'r')
file3 = open("../output/flowmax3noerror.txt", 'r')
data = []
...
plt.ylabel(r'Plynulost $\rho$ bez chyb')
plt.legend(loc='upper right')

plt.savefig("../output/maxspeedflownoerror.png")
